              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="<?php echo base_url('Operations/update_area/' . $row->area_id); ?>">Edit</a>
                    <a class="dropdown-item" href="<?php echo base_url('Operations/delete_area/' . $row->area_id); ?>">Delete</a>
                  </div>
                </div>
              </td>
            </tr>
