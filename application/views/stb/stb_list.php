  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-header">
        <a href="<?php echo base_url('create_stb'); ?>" class="btn btn-sm btn-warning">Add Set-Top Box</a>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="<?php echo base_url('update_stb/' . $row->stb_id); ?>">Edit</a>
                    <a class="dropdown-item" href="<?php echo base_url('delete_stb/' . $row->stb_id); ?>">Delete</a>
                  </div>
                </div>
              </td>
            </tr>
